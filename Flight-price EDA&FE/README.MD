...
2) Mid-Range Carriers (Median $\sim 10,000$ to $12,000$):
* Air India, Jet Airways (Economy/General), Multiple carriers, Vistara, Vistara Premium economy, and Multiple carriers Premium economy all fall into this tier.
* Their median prices are close to the overall 75th percentile ($12,373$), indicating they represent the more expensive $25\%$ of typical bookings.
3) Budget Carriers (Median $\sim 5,000$ to $7,000$):
